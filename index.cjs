...
exports.IbanValidatorClient = void 0;





class IbanValidatorClient {
  constructor(config = {}) {
    ...
    this.baseUrl = config.baseUrl || 'https://api.stanzaapi.com/iban-validator';
    this.validateEndpoint = '/api/v1/validate';
    this.parseEndpoint = '/api/v1/validate';
    this.toolUrl = 'https://stanzaapi.com/tools/iban-validator';
  }
...
exports.IbanValidatorClient = IbanValidatorClient;
exports.default = IbanValidatorClient;
